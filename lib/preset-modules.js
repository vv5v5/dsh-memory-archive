...
/** 全量模块清单（含 keep-first-round）：调用方用 `moduleNames: PRESET_MODULE_NAMES_ALL` 选择。 */
export const PRESET_MODULE_NAMES_ALL = Object.freeze([...PRESET_MODULE_NAMES, KEEP_FIRST_ROUND_MODULE_NAME])
